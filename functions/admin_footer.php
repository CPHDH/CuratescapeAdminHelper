<script>
	...
	var file_info='<?php echo cah_get_file_info();?>';
	var user_guide='<?php echo cah_resources_guide();?>';
	var setup_guide='<?php echo cah_components_guide();?>';
	var form_mod_array=<?php echo cah_item_form_helper_text_array();?>;
		
	// Dashboard
	jQuery('body.index #stats')
	.append('<div id="file_stats"><p>'+file_info+'</p><div>')
	.after(user_guide+setup_guide);		
